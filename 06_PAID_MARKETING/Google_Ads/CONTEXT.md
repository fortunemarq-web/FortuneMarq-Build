# 06 — Google Ads (FortuneMarq Own Campaigns)
**Last Updated:** March 2026 | **Status:** Not started

## Purpose
Plan FortuneMarq's own Google Ads campaigns to generate inbound leads from business owners actively searching for digital marketing services in Hubli-Dharwad.

## Target Keywords
- "digital marketing agency Hubli"
- "Google Ads agency Hubli"
- "SEO agency Hubli"
- "website design Hubli"
- "[niche] digital marketing Hubli" (gym, dental, skin, etc.)

## Campaign Type
Search campaigns — target business owners actively searching for agency services.

## Depends On
- Landing pages live (06_PAID_MARKETING parent)
- CRM deployed and working
- Telecaller system operational

## Session Log
| Date | Summary |
|---|---|
| March 2026 | Context file created. Target keywords outlined. |
---
