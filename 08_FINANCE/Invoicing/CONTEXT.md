# 08 — Invoicing
**Last Updated:** March 2026 | **Status:** Module built in FMOS — not activated

## Purpose
Define and configure the invoicing system — GST invoices, auto-numbering, payment tracking, and overdue management. FMOS already has the invoice module built (auto-number FM-2026-XXX, GST toggle, PDF generation).

## What Needs to Be Done
- [ ] Add FortuneMarq GSTIN to FMOS invoice settings
- [ ] Add SAC codes for each service type
- [ ] Set up auto-invoice trigger (agreement signed → invoice created)
- [ ] Configure payment reminder automation (7 days overdue)
- [ ] Configure campaign pause trigger (7 days overdue)
- [ ] Configure website takedown trigger (30 days overdue)

## Invoice Format
- Auto-number: FM-2026-001, FM-2026-002, etc.
...
| Date | Summary |
|---|---|
| March 2026 | Context file created. FMOS module identified. Activation checklist defined. |
---
