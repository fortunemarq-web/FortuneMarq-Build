# 02 — SEO Automation Engine
**Last Updated:** March 2026 | **Status:** Not started — Phase 3 of build plan

## Purpose
Build the system that handles 70–80% of monthly SEO delivery automatically — technical audits, keyword tracking, on-page changes via Git, content scheduling, and monthly report generation. Human (Jabeer) only involved for strategy approval and edge cases.

## How It Works (planned)
1. Crawler audits live client site weekly — flags broken links, missing metas, speed issues
2. DataForSEO API tracks keyword positions weekly
3. Google Search Console + GA4 APIs pull traffic and impression data
4. AI (Claude API) generates prioritised monthly action plan
5. Jabeer approves plan → system commits changes as Git Pull Request → auto-deploys to live site
6. Monthly report auto-generated as PDF → sent to client

## Key Technical Decisions
- All SEO changes go through Git — versioned, reviewable, reversible
- DataForSEO for rank tracking (~₹1,500/month per 30 clients)
- GitHub Actions handles auto-deployment (same pipeline as website builds)
- Backlink building remains manual — system identifies targets, Jabeer executes

## Connections to Other Folders
- **Feeds FROM:** 01_CRM_AND_TOOL (client list, service packages), 04_CLIENT_MANAGEMENT (which clients are on SEO)
- **Feeds INTO:** 08_FINANCE (monthly report completion triggers invoice), 04_CLIENT_MANAGEMENT (rank improvements update health score)
- **Depends ON:** SEO Monthly SOP (L5a) must be written and finalised first

## Services This Covers
- SEO Starter (₹7,000/month — 5 keywords)
- SEO Growth (₹10,000/month — 10 keywords)
- SEO Dominate (₹15,000+/month — 15+ keywords)

## Current Status
- [ ] SEO Monthly SOP — not written
- [ ] DataForSEO account — not set up
- [ ] GSC + GA4 API integration — not built
- [ ] Build planned for Month 5–6

## Session Log
| Date | Summary |
|---|---|
| March 2026 | Context file created. Architecture defined. Waiting on SOP completion and Phase 1+2 builds. |
---
