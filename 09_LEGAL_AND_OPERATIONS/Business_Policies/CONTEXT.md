...
**Last Updated:** March 2026 | **Status:** Not written — define after first 3 clients

## Purpose
Document all operational policies that govern how FortuneMarq works — refund policy, revision policy, communication SLA, data handling, and client conduct expectations.

## Policies to Write
- Refund Policy (no refunds on advance payments)
- Revision Policy (1 round included, additional billed)
- Communication SLA (4-hour response during business hours)
- Data Handling Policy (client credentials, campaign data)
- Pause/Termination Policy (non-payment consequences)
- Referral Policy (TBD — not planned yet)

## Session Log
| Date | Summary |
|---|---|
| March 2026 | Context file created. Policy list defined. Writing deferred to Month 2. |
---
