      ...
      {tasks.map((task) => {
        ...
        return (
          <div
            ...
            className={`flex cursor-pointer items-start gap-4 rounded-lg border border-slate-200 bg-slate-50 p-4 transition-all hover:border-[#42CA80]/30 ${
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="mt-3 flex flex-wrap items-center gap-4 text-xs">
                ...
                <div className="flex items-center gap-1.5 text-slate-500">
                  <div className="flex h-6 w-6 items-center justify-center rounded-full bg-white border border-[#42CA80]/20">
