...
export default function LeadPeekPanel({ lead, onClose, onUpdated }: LeadPeekPanelProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 print:hidden">
      ...
      {/* Panel */}
      <aside className="absolute inset-y-0 right-0 flex w-full max-w-[400px] flex-col bg-white border-l border-slate-200 shadow-2xl animate-in slide-in-from-right duration-200">
        {/* Header */}
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <select
                ...
                disabled={assigning}
                className="flex-1 rounded-lg border border-slate-200 bg-white px-3 py-2 text-[13px] font-medium text-slate-700 focus:outline-none focus:ring-2 focus:ring-brand/30 disabled:opacity-50 cursor-pointer"
              >
        ...
        <div className="border-t border-slate-100 px-5 py-3">
          <Link
            ...
            className="flex items-center justify-center gap-1.5 rounded-lg bg-slate-900 px-4 py-2.5 text-[13px] font-semibold text-white transition-colors hover:bg-slate-800"
          >
