...
export default function CallOutcomeModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/50 p-4 sm:items-center">
      <div className="w-full max-w-lg rounded-t-2xl border border-slate-200 bg-white shadow-xl sm:rounded-2xl">
        {/* Header */}
        <div className="flex items-center justify-between border-b border-[#0f0f0f] p-4 sm:p-6">
          <div>
            <h2 className="text-xl font-bold text-slate-900">How did the call go?</h2>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-[#0f0f0f] bg-slate-50 px-4 py-3 text-slate-900 focus:border-[#42CA80] focus:outline-none"
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 rounded-lg bg-[#42CA80] text-white shadow-sm transition-all duration-150 hover:bg-[#35A66A] hover:shadow active:scale-[0.98] active:bg-[#2d9960] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#42CA80] focus-visible:ring-offset-2 px-4 py-3 font-medium text-white hover:bg-[#42CA80]/90 disabled:cursor-not-allowed disabled:opacity-50"
                >
                ...
                <button
                  ...
                  disabled={isSubmitting}
                  className="rounded-lg border border-[#0f0f0f] bg-slate-50 px-4 py-3 font-medium text-slate-900 transition-colors hover:bg-white disabled:cursor-not-allowed disabled:opacity-50"
                >
                  Back
                </button>
              </div>
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              {outcomes.map((outcome) => (
                <button
                  ...
                  disabled={isSubmitting}
                  className={`flex min-h-[60px] items-center justify-center rounded-lg px-4 py-4 font-medium text-slate-900 transition-all active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 ${outcome.color}`}
                >
                  {outcome.label}
                </button>
              ))}
