...
export default function PackageModal({ client, onClose }: PackageModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 p-4">
      <div className="w-full max-w-xl max-h-[90vh] overflow-y-auto rounded-2xl bg-surface shadow-lg border border-line">
        {/* Header */}
        ...
        <div className="px-6 py-5 space-y-5">
          ...
          <div className="rounded-lg border border-info-line bg-info-soft p-4">
            ...
            {upsellEligible && (
              <div className="mt-3">
                <label className="block text-xs font-semibold text-info mb-1.5">
