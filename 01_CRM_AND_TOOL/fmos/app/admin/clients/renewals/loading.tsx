  ...
  return (
    <div className="min-h-full bg-slate-50 px-4 py-8 animate-pulse">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="h-64 rounded-xl bg-surface border border-slate-200 mb-10" />
        <div className="h-6 w-56 rounded bg-slate-200 mb-4" />
        <div className="h-48 rounded-xl bg-surface border border-slate-200" />
      </div>
    </div>
  );
}
