...
- **Niche landing pages:** template built at `/lp/[niche]/[city]` (Dental·Hubli enabled); roll out the remaining niches (seed data + enable) before campaigns. Marketing-site HOME page is live; About/Services/Work/Contact/legal pending.
