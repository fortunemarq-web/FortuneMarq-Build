# 05 — LinkedIn
**Last Updated:** March 2026 | **Status:** Not started — Month 2 priority

## Purpose
Build Jabeer's LinkedIn presence for B2B credibility, larger client attraction, and thought leadership in digital marketing and AI automation for local businesses.

## Strategy (pending — decide Month 2)
- Personal profile (Jabeer) vs company page — priority order TBD
- Content angle: founder building a systems-driven agency, AI automation for local businesses
- Target audience: business owners, managers, professionals in Karnataka

## Posts Subfolder
LinkedIn/Posts/ — all post content stored here

## Session Log
| Date | Summary |
|---|---|
| March 2026 | Context file created. Strategy decision deferred to Month 2. |
---
