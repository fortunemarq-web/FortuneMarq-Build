...
## Purpose
Store all LinkedIn post content. LinkedIn posts are longer-form, more professional, and target business decision-makers rather than general audience.

## Post Types (planned)
- Agency building journey posts
- Data insights about local business digital gaps in Karnataka
- AI tools and automation for business owners
- Case studies (once results available)
- Industry commentary

## File Naming
POST_[Topic]_[Date].md
