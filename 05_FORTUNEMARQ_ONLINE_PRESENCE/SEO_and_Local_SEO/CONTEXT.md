# 05 — FortuneMarq SEO & Local SEO
**Last Updated:** March 2026 | **Status:** Not started

## Purpose
Rank fortunemarq.com for local digital marketing keywords in Hubli-Dharwad. Optimise GMB to appear in Google Maps and local pack results. This is a 3–6 month play — not immediate revenue but builds sustainable inbound.

## GMB — Immediate Actions Needed
...
- [ ] Set up GMB posts — 2 per week from Week 1
- [ ] Request reviews from personal clients (OM SAI, Trishika, Sneha Cabs, Shanteshwara)
- [ ] Add products/services section with pricing
- [ ] Pre-populate Q&A with 5 common questions

## Target Keywords (GMB + Website)
Primary: "digital marketing agency Hubli", "SEO agency Hubli", "Google Ads agency Hubli"
Secondary: "website design Hubli", "Meta ads Hubli", "social media marketing Hubli"
Long-tail: "digital marketing for [niche] in Hubli" (gym, dental, skin clinic, etc.)

## Website SEO Plan (pending)
- Keyword research for fortunemarq.com — not done yet
- Blog content plan — not defined
- Page optimisation — not done

## Session Log
| Date | Summary |
|---|---|
| March 2026 | Context file created. GMB action list defined. Keyword targets outlined. |
---
