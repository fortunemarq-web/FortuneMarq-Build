# 05 — Single Image Posts
**Last Updated:** March 2026 | **Status:** Not started

## Purpose
Plan and store all single image post content. Used for quick stat posts, quotes, announcements, and time-sensitive content.

## Single Image Types
- Stat callout posts (one big number, one line of context)
- Quote posts (agency philosophy, Jabeer's POV)
- Announcement posts (new service, new result, new milestone)
- Festival/occasion posts (relevant only if tied to business message)
