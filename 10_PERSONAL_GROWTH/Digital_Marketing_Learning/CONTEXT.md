# 10 — Digital Marketing Learning
**Last Updated:** March 2026 | **Status:** Active — 3+ years Google Ads experience, expanding

## Purpose
Deepen expertise in every service FortuneMarq sells — Google Ads, Meta Ads, SEO, Local SEO, and emerging channels. Jabeer's technical knowledge is the product quality guarantee.

## Current Expertise Level
- Google Ads: Strong (3+ years, active freelance clients)
- Meta Ads: Intermediate
- SEO: Intermediate — building automation to scale delivery
- Local SEO / GMB: Good — building as a core service
- Social Media Management: Beginner — deferred service for now
- Analytics (GA4, GSC): Intermediate

## Learning Priorities
1. Meta Ads — advanced audience strategies, creative testing frameworks
2. SEO — technical SEO, backlink building at scale
3. GA4 — advanced tracking, conversion modelling
4. Google Ads — Performance Max, Smart Bidding optimisation
5. Marketing automation — connecting ads to CRM to reporting

## How to Use This Folder
- Note insights, frameworks, and tactics learned
- Save useful resources and course notes
- Track what's been applied in client work and what worked

## Session Log
| Date | Summary |
|---|---|
| March 2026 | Context file created. Expertise levels documented. |
---
