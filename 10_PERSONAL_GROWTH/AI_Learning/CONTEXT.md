# 10 — AI Learning
**Last Updated:** March 2026 | **Status:** Active — Claude Pro + Claude Code in daily use

## Purpose
Stay ahead of AI tools and capabilities — particularly Claude, automation frameworks, and AI-powered workflows. What Jabeer learns here directly feeds into the automation systems being built for the agency.

## Current AI Stack in Use
- Claude Pro (browser) — planning, strategy, content creation
- Claude Code (terminal) — file creation, code execution, automation
- OpenRouter / Mistral 7B — Sales AI Brain inside FMOS
- Anthropic Claude API — Strategy Engine inside FMOS

## Learning Topics
- Claude Code advanced usage — complex multi-file projects
- Prompt engineering for code generation
- AI automation architecture patterns
- Local models (Ollama) — capabilities and limitations
- AI avatar and content automation (future)
- Python automation with AI APIs

## Note on Local Models
Ollama + local models (Qwen3-Coder, Devstral) are free alternatives to Claude API. Good for repetitive code generation and learning. NOT suitable for complex architecture decisions, strategy, or content requiring deep context. Use official Claude for all FortuneMarq build work.

## Session Log
| Date | Summary |
|---|---|
| March 2026 | Context file created. Current AI stack documented. |
---
